...
import { SvgIcon, Empty, Text } from '@kodiak-ui/primitives'

export default { title: 'Primitives/Empty', component: Empty }

export function EmptyWithSvgIllustration() {
  return (
    <Empty
      illustration={
        <SvgIcon
    ...
    >
      <Text as="span">
        No contacts were found associated with your organization.
      </Text>
    </Empty>
  )
}
