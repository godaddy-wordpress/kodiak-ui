...
export default { title: 'Message/Banner', component: Message }

export function Initial() {
  return (
    <Message variantKey="bannerMessages">
      <Box sx={{ textAlign: 'center', width: '100%' }}>Testing a message</Box>
    </Message>
  )
}
...
export function Warning() {
  return (
    <Message variant="warning" variantKey="bannerMessages">
      <Box sx={{ textAlign: 'center', width: '100%' }}>A warning message</Box>
    </Message>
  )
}
...
export function Danger() {
  return (
    <Message variant="danger" variantKey="bannerMessages">
      <Box sx={{ textAlign: 'center', width: '100%' }}>A danger message</Box>
    </Message>
  )
}
  ...
  return (
    <Message variantKey="bannerMessages">
      ...
      >
        <SvgIcon
          viewBox="0 0 16 16"
          sx={{ width: '24px', height: '24px', mr: 4, color: 'blue.2' }}
        >
